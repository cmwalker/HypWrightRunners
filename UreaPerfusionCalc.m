...
% accuracy
function [raw,t] =  UreaPerfusionCalc(base)
import HypWright.*
import HypWright.Models.*
%% init variables
Default = struct('gamma', 67.262e6, 'readBandwidth', 4096, 'rfBandwidth', 5000,...
    'nPoints', 2048, 'ureaCenter', 1025,'FWHMRange', 100,...
    't0',0,'endTime', 100, 'T1a', 56, 'T2a', 0.02, 'T1b', 10,...
    'T2b', 0.02, 'kve', 0.06, 'vb', 0.09, 've', .91, 'ppma', 0,...
